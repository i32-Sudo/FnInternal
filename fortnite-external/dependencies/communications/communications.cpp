...
auto atx::memory_c::get_process_pid(
...
auto atx::memory_c::initialize_handle( ) -> bool
{
...
auto atx::memory_c::get_image_base(
...
auto atx::memory_c::write_virtual(
...
auto atx::memory_c::read_virtual(
	const std::uintptr_t address, 
	void* buffer,
	const std::size_t size ) -> bool
{
...
auto atx::memory_c::translate_address(
